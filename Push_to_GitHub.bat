...
echo.
echo ============================================
echo   PharmaCU Flashcard Private - Push to GitHub
echo ============================================
echo.
...
echo.
if %ERRORLEVEL%==0 (
    echo [SUCCESS] Push complete! Flashcards are now live on GitHub Pages.
) else (
    echo [ERROR] Push failed. Check your git remote or internet connection.
)
echo.
pause
